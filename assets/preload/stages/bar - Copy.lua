function onCreate()
	...
	addAnimationByPrefix('otherdudes', 'dance', 'otherdudes chillin', 14, false);
	...
	makeLuaSprite('image (4)', 'image0 (4)', 965, 171);
	scaleObject('image0 (4)', 0.35, 0.35);
	setScrollFactor('image0 (4)', 0.7, 1);
	setProperty('image0 (4).antialiasing', true);
	setObjectOrder('image0 (4)', 7);
